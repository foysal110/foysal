...
â•‘ Creator  : Md Nime islam                      â•‘
â•‘ Github   : https://github.com/F3ogbaba03  â•‘
â•‘ Facebook : Md Nime islam                           â•‘
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-",)
    print("\t  Facebook : Md Nime islam    ")
    print("\t  Fb page  : Md Nime islam   ")
    print("\t  Github   : Md Nime islam   ")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    my_server=requests.get("https://www.facebook.com/100061043330299/posts/pfbid02ZG78gghaeEdjhr1Vo6MyvoHcPZkrCZcpH3ycnoEsswzLdVF5aZ8GueSYoHZxazael/?app=fbl").text
    if f_token in my_server:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100061043330299")
        exit()
...
â•‘ Creator  : Md Nime islam                                    â•‘
â•‘ Github   : https://github.com/F3ogbaba03  â•‘
â•‘ Facebook : Md Nime islam    ðŸ™‚â¤ï¸                â•‘
â•‘ Brothers :            Md Nime islam                              â•‘
â•‘ NOTE     :   Paid ToolðŸ˜“                                    â•‘
...
def menu_apikey():
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100061043330299");xyz()
    elif hamii in ["3","03"]:
        os.system("xdg-open https://wa.me/+8801753804769")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
